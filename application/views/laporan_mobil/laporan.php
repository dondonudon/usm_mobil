            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">LAPORAN MOBIL</h3>
                    </div>
                    ...
                    <div class="box-body">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 select2-hidden-accessible" id="status" name="status" style="width: 100%;">
                                        ...
                                        <option value="6">Terpakai</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <form target="_blank" action="<?php base_url();?>laporan_mobil/report" method="post">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('laporan_mobil/ajax_list') ?>",
                "type": "POST",
                "data": function(data) {
