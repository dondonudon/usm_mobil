                    ...
                    <div class="box-body">
                        <div style="padding-bottom: 10px;">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    <label for="FirstName" class="col-sm-2 control-label">Karyawan</label>
                                    <div class="col-sm-4">
                                        <?php echo select2_dinamis('id_karyawan', 'mst_karyawan', 'nama', 'id', 'Karyawan') ?>
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <form target="_blank" action="<?php base_url();?>laporan_history/report" method="post">
                            <input type="hidden" name="tanggal_a" id="tanggal_a">
                            <input type="hidden" name="tanggal_b" id="tanggal_b">
                            <input type="hidden" name="_karyawan" id="_karyawan">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('laporan_history/ajax_list') ?>",
                "type": "POST",
                "data": function(data) {
