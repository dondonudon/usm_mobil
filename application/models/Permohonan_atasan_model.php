...
class Permohonan_atasan_model extends CI_Model
{
    ...
    public function json()
    {
        ...
        $this->datatables->add_column('action', anchor(site_url('permohonan_atasan/update/$1'), '<i class="fa fa-pencil-square-o" aria-hidden="true"></i>', array('class' => 'btn btn-danger btn-sm')) . "
                ", 'id');
